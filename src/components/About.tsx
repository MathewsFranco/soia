export function About() {
  return (
    <section
      className="bg-black px-8 md:px-20 py-25 gap-15 flex flex-col md:flex-row tracking-wide leading-relaxed text-2xl "
      id="about"
    >
      <div className="relative flex flex-col justify-center bg-black text-white md:w-1/2">
